...
`commission`,`opresult`,`divisaid`,`accountid`,
 `pattern1id`,`pattern2id`, `setup1id`, `setup2id`,`tickerid`,`status`) VALUES 
(1,20240809,1,1,1, '14:00','14:30','buy',100.00,180.0, 80,1, 4.5,80.0,1,1,   1,'Giro',"m5",1, 1,'opened'), 
(2,20240809,1,1,2, '14:40','14:55','sell',90.00,80.0, -19,1, 4.5,-50.0,1,1,   2,'Fac',"m3",1, 1,'opened'),
(3,20240811,1,1,3, '14:00','14:30','buy',100.00,180.0, 80,1, 4.5,80.0,1,1,  1,'Giro',"m5",1, 1,'closed'), 
(4,20240811,2,1,1, '14:40','14:55','sell',90.00,80.0, -19,1, 4.5,-50.0,1,1,   1,'Cont',"m3",1, 1,'opened');
